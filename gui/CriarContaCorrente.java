			...
			if(PessoaFisica.verificaCPF(fdId.getText())) {
				...
				try {
					...
					if(!BancoDeDados.verificarPessoaFisica(fdId.getText())){
						...
						conta = new ContaCorrente(pessoa, fdSenha.getText());
                                                //Se o CPF nao constar no banco de dados é criado uma nova pessoa física,conta corrente com os dados fornecidos
				...
				try {		
					if(!BancoDeDados.verificarPessoaJuridica(fdId.getText())) {
						...
						conta = new ContaCorrente(pessoa, fdSenha.getText());
                                                //Se o CNPJ nao constar no banco de dados é criado uma nova pessoa juridica,conta corrente com os dados fornecidos

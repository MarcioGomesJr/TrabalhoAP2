...
//Classes que monta a janela para registrar pessoas físicas
//Rafael Nunes Santana

public class RegistrarPessoaF extends JanelaBase implements ActionListener {
	...
	public RegistrarPessoaF(Point posicao) {
		
		//Passando as especificações para a super classe
		super(600, 500, "Registrar Pessoa Física", posicao);
		
		//Instancioando componentes e adicionando os botões ao Action Listener
